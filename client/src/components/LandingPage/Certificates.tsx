...
// Replace with your actual certification images
...
const Certificates = () => {
    ...
    '>
        ...
        '>
          ...
          max-w-3xl mx-auto
        '>
                    We are proud to showcase our certifications and accreditations that demonstrate our commitment to quality, authenticity, and excellence in every piece we create.        </p>
            </div>
